...
public class ElephantTest {
	...
	public void testDiagUpLeft() {
		...
		boardInit(test);
		Piece p = new Elephant(test.chessBoard[3][3], "white");
	...
	public void testOutOfBoundsMove() {
		Board test = new Board(false);
		boardInit(test);
		Piece p = new Elephant(test.chessBoard[0][7], "white");
	...
	public void testAttackEnemy() {
		...
		boardInit(test);
		Piece p = new Elephant(test.chessBoard[3][3], "white");
		Piece enemy = new Elephant(test.chessBoard[5][5], "black");
	...
	public void testAttackFriendly() {
		...
		boardInit(test);
		Piece p = new Elephant(test.chessBoard[3][3], "white");
		Piece friendly = new Elephant(test.chessBoard[5][5], "white");
